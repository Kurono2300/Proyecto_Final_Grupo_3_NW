...
<?php echo isset($_SESSION['errores']) ? Utils::ShowError('correo') : '' ?>
    ...
    <div class="form-group mx-2 col-5">
        ...
        <input type="password" name="contraseña" placeholder="Contraseña" required class="form-control" pattern=".{8,}" required title="8 caracteres minimo, 1 mayuscula, 1 numero, 1 caracter especial">
